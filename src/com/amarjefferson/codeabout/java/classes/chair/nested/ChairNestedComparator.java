...
public class ChairNestedComparator {
	/**
	 *  Instance variables
	 */
	 ...
	 * @param aStyle
	 */
	public ChairNestedComparator(ChairConstants.Colors aColor, ChairConstants.Styles aStyle) {
		this.initialize();
		setColor(aColor);
		setStyle(aStyle);
	 ...
	 * @return
	 */
	public ChairNestedComparator setColor(ChairConstants.Colors aColor) {
		this.aColor = aColor;
		return this;
	}
	 ...
	 * @return
	 */
	public ChairNestedComparator setStyle(ChairConstants.Styles aStyle) {
		this.aStyle = aStyle;
		return this;
	}
	 ...
	 * @return
	 */
	public ChairNestedComparator setCapacity(double limit) {
		this.capacity = limit;
		return this;
	}
	...
	public static void main(String[] args) {
		ChairNestedComparator chair = new ChairNestedComparator();             // use default constructor
		...
		ChairNestedComparator chair2 = new ChairNestedComparator(ChairConstants.Colors.RED, ChairConstants.Styles.MODERN);
		...
		// compare the two chairs using static nested class
		ChairNestedComparator.CompareChairsStatic comp = new ChairNestedComparator.CompareChairsStatic();
		System.out.println("Result of Comparison: " + comp.compare(chair, chair2));

		// compare the two chairs using non-static nested class
		// inner class can be accessed only through an instance of the enclosing class
		ChairNestedComparator.CompareChairs comp2 = chair2.new CompareChairs();
		System.out.println("Result of Comparison: " + comp2.compare(chair, chair2));
	}
	...
	public static class CompareChairsStatic implements Comparator<ChairNestedComparator> {

		@Override
		public int compare(ChairNestedComparator o1, ChairNestedComparator o2) {
	...
	public class CompareChairs implements Comparator<ChairNestedComparator> {
